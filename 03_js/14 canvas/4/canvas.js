function a(){
	...
	ande.fillRect(10,10,200,150); //rectangle x=10,y=110,width=200,height=150
...
function b(){
	var praveen=document.getElementById("mycanvas");
	var ande=praveen.getContext("2d");
	var display=ande.createLinearGradient(0,50,200,0); //x1,y1,x2,y2 //took y1 value
	...
	ande.fillStyle=display;
	ande.fillRect(10,200,200,150); //rectangle x=10,y=110,width=200,height=150
